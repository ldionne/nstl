...
#define NSTL_MAX_ELEMENT(SinglePassReadableIterator, ValueType)                \
    NSTL_I_MAX_ELEMENT(                                                        \
...
#define NSTL_I_MAX_ELEMENT(algo, Iter, Value)                                  \
NSTL_TYPE(algo,                                                                \
                                                                               \
(defun max_element                                                             \
...
#define NSTL_MAX_ELEMENT_COMP(SinglePassReadableIterator, ValueType, Compare)  \
    NSTL_I_MAX_ELEMENT_COMP(                                                   \
...
#define NSTL_I_MAX_ELEMENT_COMP(algo, Iter, Value, Comp)                       \
NSTL_TYPE(algo,                                                                \
                                                                               \
...
static NSTL_INLINE Iter algo(Iter first_, Iter last, Comp comp) {              \
    ...
    while (nstl_ne(Iter, Iter)(nstl_inc(Iter)(&first), last))                  \
        if (comp(nstl_deref(Iter)(result), nstl_deref(Iter)(first)))           \
