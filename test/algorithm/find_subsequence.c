/**
 * Unit tests for the @em find_subsequence and @em find_subsequence_comp
 * algorithms.
 */
...
NSTL_INSTANTIATE(NSTL_FIND_SUBSEQUENCE(nstl_pint, nstl_pint, nstl_int))
NSTL_INSTANTIATE(
    NSTL_FIND_SUBSEQUENCE_COMP(nstl_pint, nstl_pint, Compare, nstl_int))

#define find_subsequence nstl_find_subsequence(nstl_pint, nstl_pint)
#define find_subsequence_comp(first1, last1, first2, last2)                    \
    nstl_find_subsequence_comp(nstl_pint, nstl_pint, Compare)(                 \
...
static void test_should_return_first_when_searching_empty_range(void) {
    ...
    nstl_pint found = find_subsequence(first1, last1, first2, last2);
    nstl_pint found_comp = find_subsequence_comp(first1, last1, first2,last2);
...
#undef find_subsequence_comp
#undef find_subsequence

extern void test_fixture_find_subsequence(void) {
    test_fixture_start();
